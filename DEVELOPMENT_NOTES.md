...
* (It would be very nice to have an __init__.py file and more modularization.
* That way, one could use the code as a library and not as a script! This would be an awesome thing to do because it reduces boilerplate.
